...
300 O=5:P=T*20:GOSUB800:W=0:B=0: FORX=1TO4:IF C(X)=C(X+4)THEN B=B+1:GOTO500
400 FORY=1TO4:G=C(Y+4):IF X<>Y AND C(Y)<>G AND C(X)=G THEN W=W+1:C(Y+4)=0:GOTO500ELSENEXT
